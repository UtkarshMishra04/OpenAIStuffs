...
class AveragePolicyBuffer(object):
...
class Actor:
    ...
    def __init__(self,state_dim,action_dim):
        ...
        actor_2 = Dense(32, kernel_initializer='random_uniform', bias_initializer='zeros', activation='relu')(actor_1)
        actor_3 = Dense(32, kernel_initializer='random_uniform', bias_initializer='zeros', activation='relu')(actor_2)
...
def preprocess_state(env,state,state_dim):
    ...
    return modified_state.reshape((state_dim,)).reshape((1,-1))
...
def train(env, actor, actor_noise, state_dim, action_dim):
    ...
    policy_buffer = AveragePolicyBuffer(buffer_size=10,random_seed=123)
        ...
        while terminal==False:
            ...
            if replay_buffer.size() > min_buffer_size:
                ...
                for k in range(batch_size):
                    ...
                    ep_ave_max_q += np.amax(model_actor.predict(s_batch[k].reshape((1,-1)))[0])
